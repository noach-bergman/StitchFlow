          ...
          <div className="bg-white rounded-[2.5rem] w-full max-w-md shadow-2xl animate-in zoom-in duration-200 overflow-hidden">
            ...
            <form onSubmit={handleAddUser} className="p-8 space-y-5 text-right">
              ...
              <div className="space-y-1">
                ...
                <input name="password" type="text" required placeholder="הגדר סיסמה" className="w-full px-5 py-3 rounded-2xl border border-gray-100 outline-none focus:ring-2 focus:ring-rose-200 transition-all font-bold text-gray-700" />
              </div>
